...
<body class="bg-gray-200">
    <nav class="bg-white border-gray-200 shadow-md dark:bg-gray-900">
        <div class="flex flex-wrap items-center justify-between max-w-screen-md p-4 mx-auto"> 
            <h3 class="text-xl font-bold">GallerNa</h3>
  ...
  <!--hero mobar-->
<section>
    <h1 class="text-center font-hurricane text-5xl ">Gallery Foto</h1>
</section>
<section>
    <h1 class="text-center font-hurricane text-5xl"></h1>
    </section>
    </body>
<!---gambar bokep ku--->
<br><br>
    ...
    <div class="flex justify-center gap-4">
        <div>
            <div class="filex flex flex-col gap-4">
                <div class="">
            <img src="/assets/images (1).jfif" alt="" class="rounded-lg">
            </div>
            <div class="">
            <img src="/assets/images (2).jfif" alt="">
            </div>
            </div>
            </div>
            <div class="">
           <div><img src="/assets/meong.jfif" alt="" class="rounded-lg">
        </div>
    </div>
</section>
</html>
